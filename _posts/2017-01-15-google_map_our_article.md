...
As we can see on [that graph](https://github.com/YvesCR/yvescr.github.io/assets/images/special/map_by_hour.png), I am pretty quiet during the night, wake up at Acton between 8 and 9 and run around London the rest of the day, coming back home between 7 and 10 p.m..
...
I have created a graph by type that can [be found here](https://github.com/YvesCR/yvescr.github.io/assets/images/special/map_by_type.png).
